...
AppManagementWindow::AppManagementWindow(ADBTools *tools, QWidget *parent) : QMainWindow(parent) {
    ...
    QObject::connect(ui->checkbox_select_all_user_app, SIGNAL(stateChanged(int)), this,
                     SLOT(on_checkbox_select_all_user_click(int)));
    QObject::connect(ui->checkbox_select_all_system_app, SIGNAL(stateChanged(int)), this,
                     SLOT(on_checkbox_select_all_system_click(int)));
...
void
AppManagementWindow::on_backup_app_complete(QString current_app, bool backup_success, QString next_app, bool finish) {
    if (!backup_success) {
...
void
AppManagementWindow::on_uninstall_complete(QString current_app, bool uninstall_success, QString next_app, bool finish) {
